...
FOOD_CATEGORIES = [
    'Frozen Desserts', 'Soy/Tofu', 'Pie', 'Chicken', 'Vegetable',
       ...
       'Southwest Asia (middle East)', 'Spanish', 'Jellies', 'Gelatin',
       'Chicken Thigh & Leg', 'Cauliflower', 'Tuna', 'Citrus', 'Apple',
       'Berries', 'Greek', 'Peppers', 'Clear Soup', 'Mexican',
       'Raspberries', 'Crawfish', 'Beef Organ Meats', 'Strawberry',
       'Shakes', 'Short Grain Rice', 'Salad Dressings', 'Manicotti',
       'Spicy', '< 15 Mins', 'Cajun', 'Sourdough Breads', 'Oven',
       'Microwave', 'Asian', 'Corn', 'Melons', 'Swiss', 'Papaya',
       'Broil/Grill', 'No Cook', '< 4 Hours', 'Roast', 'Curries',
       'Orange Roughy', 'Thai', 'Canadian', 'Bass', 'Veal',
       'Medium Grain Rice', 'Japanese', 'Penne', 'Mussels', 'Elk',
       'Colombian', 'High Protein', 'Black Beans', 'Rabbit', 'Caribbean',
       'Turkish', 'Kid Friendly', 'Christmas', 'For Large Groups',
       'One Dish Meal', 'Whole Turkey', 'Chinese', 'Roast Beef', 'Grains',
       'Russian', 'Yam/Sweet Potato', 'Native American', 'Trout', 'Gumbo',
       'Vegan', 'African', 'Meatballs',
       'Whole Duck', 'Scandinavian', 'Greens', 'Catfish', 'Dehydrator',
       'Duck Breasts', 'Ham', 'Stocks', 'Savory', 'Vietnamese',
       'Stir Fry', 'Polish', 'Deer', 'Wild Game', 'Pheasant',
       'No Shell Fish', 'Spring', 'Collard Greens', 'Quail', 
       'Canning', 'Moroccan', 'Pressure Cooker', 'Squid', 'Winter',
       'Pasta Shells', 'Danish', 'Lebanese', 'Creole',
       'Tarts', 'Spinach', 'Homeopathy/Remedies', 'Austrian', 
       'Thanksgiving', 'Moose', 'Swedish', 'High Fiber', 'Norwegian',
        'Kosher',  'Australian',
       'Meatloaf'
]
